...
public class CustomerDashboard {
    ...
    public CustomerDashboard(String customerId) {
        ...
        mainPanel = new Style.BackgroundPanel(); // Uses your Style class
        mainPanel.setLayout(cardLayout);

        // 3. Add Views (Connecting logic to UI)
    ...
    // The Home Screen with Navigation Buttons
    private JPanel createHome() {
        ...
        logoutBtn.addActionListener(e -> {
            ...
            new OpenFrame4(); // Go back to login
        });
